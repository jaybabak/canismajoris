...
module.exports = async function optInUser(req, res) {
  ...
  try {
    await emailService.sendEmail(
      ...
      `<h1>${submittedFormValues.name}, we really appreciate you signing up for our beta release!</h1><div><h3>We'll let you know when we launch in ${submittedFormValues.city}!</h3></div><div style="color:c9c9c9;">Copyright Halal Food Finder App 2019. All Rights Reserved. Ottawa, Canada.</div>`
    );
