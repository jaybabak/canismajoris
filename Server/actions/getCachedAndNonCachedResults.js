...
const getYelpData = require("./getYelpData");
const getYelpAdditionalData = require("./getYelpDataAdditionalData");
// Redis config.
...
module.exports = async function getCachedAndNonCachedResults(rid, res) {
  // See if request has been cached already.
  redis_client.get(rid, async (err, data) => {
    ...
    results = await getRestaurantById(rid);
